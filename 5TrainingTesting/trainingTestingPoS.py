...
inputFile="trainingVectors-"+str(NgramType)+"-"+str(NgramNumber)+"PoSTag.txt"
inputFile2="testVectors-"+str(NgramType)+"-"+str(NgramNumber)+"PoSTag.txt"
inputFile3="goldStandar.qrel"
outputFile="Model-"+str(NgramType)+"-"+str(NgramNumber)+"PoSTag.txt"
